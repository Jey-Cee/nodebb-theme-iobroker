...
$(window).on('action:ajaxify.end', function(){
	showSignatures();
	let navbarHeight = parseInt($('.navbar-fixed-top').css('height'));
	let breadcrumbHeight = parseInt($('.breadcrumb').css('height'));

	$(window).scroll(function(){
		let navbarTop = parseInt($('#header-menu').css('top'));
		if($(this).scrollTop() > breadcrumbHeight){

			$('.breadcrumb').addClass('container');
			$('.breadcrumb').css('top', navbarHeight + navbarTop);

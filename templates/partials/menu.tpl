					...
					<li id="user_label" class="dropdown">
						...
						<ul id="user-control-list" component="header/usercontrol" class="dropdown-menu" aria-labelledby="user_dropdown">
							...
							<li role="presentation" class="divider"></li>
                                    <li><a href="{config.relative_path}/user/{user.userslug}/topics"><i class="fa fa-circle-o"></i> [[global:topics]]</a></li>
                                    <li><a href="{config.relative_path}/user/{user.userslug}/posts"><i class="fa fa-dot-circle-o"></i> [[global:posts]]</a></li>
							<li role="presentation" class="divider"></li>
                                    <li><a href="{config.relative_path}/user/{user.userslug}/bookmarks"><i class="fa fa-bookmark-o"></i> [[user:bookmarks]]</a></li>
                                    <li><a href="{config.relative_path}/user/{user.userslug}/watched"><i class="fa fa-eye"></i> [[user:watched]]</a></li>
                                    <li><a href="{config.relative_path}/user/{user.userslug}/categories"><i class="fa fa-list"></i> [[user:watched_categories]]</a></li>
                                    <li><a href="{config.relative_path}/user/{user.userslug}/following"><i class="fa fa-user-o"></i> [[user:following]]</a></li>
							<li role="presentation" class="divider"></li>
							<li>

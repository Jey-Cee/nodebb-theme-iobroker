...
<div class="clearfix post-footer">
	...
	<div component="post/signature" data-uid="{posts.user.uid}" class="post-signature <!-- IF persona:posts:signatures -->hidden<!-- ENDIF persona:posts:signatures -->">{posts.user.signature}</div>
